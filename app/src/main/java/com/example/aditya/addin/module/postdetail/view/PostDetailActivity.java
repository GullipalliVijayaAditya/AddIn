package com.example.aditya.addin.module.postdetail.view;
...
import com.example.aditya.addin.databinding.ActivityPostDetailBinding;
import com.example.aditya.addin.module.main.profile.model.BlogPost;
import com.example.aditya.addin.module.postdetail.view.commentsdialog.CommentsDialog;
import com.example.aditya.addin.module.postdetail.view.likedialog.LikesDialog;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.id";
    private static final String EXTRA_NAME = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.name";
    private static final String EXTRA_OWNER_ID = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.owner_id";
    private static final String EXTRA_OWNER_PHOTO_URL = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.owner_photo_url";
    private static final String EXTRA_DATE = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.date";
    private static final String EXTRA_CONTENT = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.context";
    public static final String EXTRA_LIKE = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.like";
    public static final String EXTRA_COMMENT = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.comment";
    public static final String EXTRA_VIEW = "com.example.aditya.addin.module.postdetail.view.PostDetailActivity.view";
